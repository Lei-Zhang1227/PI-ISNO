...
def run(config, args):
    ...
    model = Model(2, modes, width, bandwidth, out_channels=6, dim=2, triL=0).to(device)
...
def test(config, args):
    ...
    test_data_1_4x = FNODatasetMult_A(file_path=file_path,
                                      initial_step=1,
                                      out_step=9,
                                      sub_x=4,
                                      sub_t=1,
    ...
    test_data_1_8x = FNODatasetMult_A(file_path=file_path,
                                      initial_step=1,
                                      out_step=9,
                                      sub_x=8,
                                      sub_t=1,
